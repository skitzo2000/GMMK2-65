...
[0] = LAYOUT(
  ...
  KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  ACTION_TAP_DANCE_DUAL_ROLE(MO(11), 12),    KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[1] = LAYOUT(
  ...
  KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,            KC_PGUP,
  KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            KC_UP,    KC_PGDN,
  KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_TRANSPARENT,    KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[11] = LAYOUT(
  ...
  _______,  _______,  RGB_VAI,  RGB_VAD,  RGB_RMOD,  RGB_MOD,  _______,  _______,  _______,  _______,  _______,  _______,                       _______,
  _______,  _______,  RGB_HUI,  RGB_HUD,  RGB_SPD,  RGB_SPI,  KC_MUTE,  KC_VOLU,  KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,   KC_VOLU,  _______,
  _______,  _______,  _______,                                RESET,                                  _______,  _______,  KC_MUTE,  KC_VOLD, _______),

[12] = LAYOUT(
   KC_GRV,    TO(0),    TO(1),    TO(2),    TO(3),    TO(4),    TO(5),    TO(6),    TO(7),    TO(8),   TO(9),   _______,   _______,   _______,  KC_INS,
  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_SCRL,  KC_PAUS,   _______,        KC_HOME,
  _______,  _______,  RGB_VAI,  RGB_VAD,  RGB_RMOD,  RGB_MOD,  _______,  _______,  _______,  _______,  _______,  _______,                       _______,
  _______,  _______,  RGB_HUI,  RGB_HUD,  RGB_SPD,  RGB_SPI,  KC_MUTE,  KC_VOLU,  KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,   KC_VOLU,  _______,
  _______,  _______,  _______,                                RESET,                                  _______,  _______,  KC_MUTE,  KC_VOLD, _______),
